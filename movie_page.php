...
<div style="position: relative; left:0; top:0;">
    <img src= '<?php echo $poster_url?>' class = "bg_image"/>
    <img src= '<?php echo $poster_url?>' class = "image"/>
</div>
<div class = "text">
    ...
    <h1>Review 1</h1>
    <textarea readonly id="Review" name="Review" rows="11" cols="140"><?php
    ...
    if($review->results[0]->content!=NULL){
        ...
        restore_error_handler();?></textarea>
